          ...
          <div className="dashboard-featured-card rounded-[20px] p-[18px]">
            <div className="mb-4 flex flex-wrap items-center gap-3">
              ...
              <div className="flex flex-wrap gap-2 text-[10px] font-medium">
                <span className="rounded-full bg-[var(--accent)]/10 px-2.5 py-1 text-accent">
                  Net {currentNet !== null ? formatCurrency(currentNet) : "-"}
                </span>
              ...
              <div className="sm:ml-auto flex rounded-[8px] bg-surface-muted p-0.5">
...
export function DashboardWorkspace({
  ...
  return (
    <main className="min-h-svh bg-app text-primary">
      ...
      {isTransactionsPage ? (
        <div className="flex w-full flex-col gap-4 px-3 pt-[70px] pb-3">
          <section>
            <div className="flex min-w-0 flex-col gap-3">
              <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                {summaryCards.map((card) => (
                  <SummaryCard
                    ...
                    valueClassName={cn(
                      "truncate text-xl font-bold tracking-normal",
                      card.color,
                    )}
                  />
                ))}
              ...
              {isTransactionsPage ? (
                <section className="overflow-hidden rounded-[20px] border border-subtle bg-surface shadow-[0_10px_30px_rgba(15,23,42,0.03)] dark:shadow-none">
                  <div className="flex flex-col gap-2 border-b border-subtle px-[18px] py-3 xl:flex-row xl:flex-wrap xl:items-center xl:py-3.5">
